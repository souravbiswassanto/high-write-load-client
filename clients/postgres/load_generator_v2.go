...
func (lg *LoadGeneratorV2) checkDataLossOptimized(ctx context.Context, insertedIDs []int64) (int64, int64, error) {
...
func (lg *LoadGeneratorV2) checkDataLossSampled(ctx context.Context, minID, maxID, totalInserted int64) (int64, int64, error) {
